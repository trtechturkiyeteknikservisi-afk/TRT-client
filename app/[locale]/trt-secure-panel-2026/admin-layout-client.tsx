...
export default function AdminLayoutClient({
  ...
  return (
    <div className="h-screen bg-background flex flex-col lg:flex-row font-almarai overflow-hidden">
      ...
      <aside className={cn(
        "fixed lg:sticky top-0 h-screen w-72 shrink-0 flex-shrink-0 bg-card border-r rtl:border-r-0 rtl:border-l border-border/50 flex flex-col shadow-2xl lg:shadow-xl z-50 transition-transform duration-300 ease-in-out lg:translate-x-0",
