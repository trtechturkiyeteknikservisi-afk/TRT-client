  ...
  return (
    <div className="space-y-12 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-3 bg-card/50 backdrop-blur-xl p-10 rounded-[2.5rem] border-2 border-border/50 shadow-xl shadow-black/5 space-y-10 relative overflow-hidden">
                      ...
                      return (
                        <div key={i} className="w-full mx-2 group relative flex flex-col justify-end">
                            ...
                            <motion.div 
                              ...
                              className={cn(
                                "absolute -top-12 left-1/2 -translate-x-1/2 px-3 py-1.5 rounded-xl text-[10px] font-black shadow-lg border whitespace-nowrap z-10",
                                count > 0 
