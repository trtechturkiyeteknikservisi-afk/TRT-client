      ...
      <div className="flex select-none">
        ...
        >
          {duplicatedBrands.map((brand, index) => (
            <div
              key={`${brand}-${index}`}
              className="flex items-center justify-center min-w-[150px] h-16 bg-background/40 border border-white/5 rounded-2xl px-8 hover:border-primary/30 transition-all group/item"
            >
