...
export function TrustBadges() {
  ...
  return (
    <section className="py-12 md:py-20 bg-background relative border-y border-border/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                {trustItems.map((item, index) => (
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="group relative flex flex-col items-center text-center p-8 rounded-xl bg-card/40 backdrop-blur-md border border-border hover:border-primary/50 transition-all duration-300 hover:-translate-y-2 shadow-sm hover:shadow-lg hover:shadow-primary/10"
                    >
